//
//  SnapMeUserTableViewController.swift
...
class SnapMeUserTableViewController: UITableViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate
{
                            ...
                            if let imageToDisplay = UIImage(data: imageData) {
                                ...
                                alertController.addAction(UIAlertAction(title: "OK", style: .default, handler: { (action) in
                                    ...
                                    _ = Timer.scheduledTimer(withTimeInterval: 5, repeats: false, block: { (timer) in
                                        ...
                                        self.timer = Timer.scheduledTimer(timeInterval: 5, target: self, selector: #selector(SnapMeUserTableViewController.checkForMessages), userInfo: nil, repeats: true)
    ...
    override func viewDidLoad() {
        ...
        timer = Timer.scheduledTimer(timeInterval: 5, target: self, selector: #selector(SnapMeUserTableViewController.checkForMessages), userInfo: nil, repeats: true)
